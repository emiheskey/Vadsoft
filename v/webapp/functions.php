...
function GetKPIForDept($connection,$dept_id,$astyp_id, $kpi_id = null){ 
    ...
    if ($dept_id)
        if($kpi_id) {
            ...
            $sql = "SELECT * FROM assessment_params WHERE asp_astyp='$astyp_id' and asp_dept = '$dept_id' GROUP BY asp_kpi";
        }
...
function GetKPIForUnit($connection,$unit_id,$astyp_id, $kpi_id = null){ 
    ...
    if ($unit_id)
        if($kpi_id) {
            ...
            $sql = "SELECT * FROM assessment_params WHERE asp_astyp='$astyp_id' and asp_unit = '$unit_id'  group by asp_kpi";
        }
        // assign query
    else
        // assign query
...
function GetStaffKPIHistory($connection,$id,$kpi,$listtype,$ass_key_id,$ass_type)
{
    ...
    $query = $connection->query("SELECT * FROM assessment_result WHERE ass_user='$id' AND kpi_id='$kpi'");
    while ($row = $query->fetch())
    {
        // $cat = $row['ass_param_cat'];
        // $ass_id = $row['ass_id']; 
