        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <div class="account-wall">
				...
				<form class="form-signin" name="frm_login" id="frm_login" action="login.php" method="">
					<h2><span style="font-weight:bold">VAD</span><span style="font-weight:100">SOFT</span></h2>
                    <!-- Error Alert -->
                    <br>
                    <div id="return_status_msg"></div>
               		...
               		<button class="btn btn-lg btn-default btn-block" id="btn_login">Sign In</button>
					<br />
